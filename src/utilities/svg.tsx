export const CardIcon = (props: { size: number }) => {
  return (
    <svg
...
export const ChatWithHeartIcon = (props: { size: number }) => {
  return (
    <svg
      ...
      height={props.size}
      fill="currentColor"
      className="bi bi-chat-left-heart-fill text-light-yellow"
      viewBox="0 0 16 16"
    >
...
export const ChatIcon = (props: { size: number }) => {
  return (
    <svg
      ...
      height={props.size}
      fill="currentColor"
      className="bi bi-chat-left-dots-fill text-light-yellow"
      viewBox="0 0 16 16"
    >
...
export const NewsIcon = (props: { size: number }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={16}
...
export const OpenMenuIcon = () => {
  return (
    <svg
      ...
      height={24}
      fill="currentColor"
      className="bi bi-android text-light-yellow"
      viewBox="0 0 16 16"
    >
...
export const CloseMenuIcon = () => {
  return (
    <svg
      ...
      height={32}
      fill="currentColor"
      className="bi bi-android2 text-light-yellow"
      viewBox="0 0 16 16"
    >
